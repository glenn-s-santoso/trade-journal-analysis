...
from src.service.google_auth import GoogleAuthService, ALL_SCOPES
...
class GoogleDriveService:
    ...
    def upload_directory(self, 
                        ...
                        date_subfolder: Optional[str] = None) -> Dict[str, Dict]:
        ...
        if date_subfolder:
            target_folder_id = self.get_or_create_folder(date_subfolder, parent_folder_id=main_folder_id)
