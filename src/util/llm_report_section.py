...
def create_llm_analysis_section(llm_analysis):
    """
    ...
    Returns:
        str: HTML content for the LLM analysis section
    """
    if not llm_analysis:
        return ""
    ...
    overall_assessment = llm_analysis.get("Overall Performance Assessment", 
                           llm_analysis.get("overall_performance_assessment", "No assessment provided"))
    
    # Format strategy assessment
    strategy_assessment = llm_analysis.get("Strategy Effectiveness", 
                            llm_analysis.get("strategy_effectiveness", "No strategy assessment provided"))
    
    # Format psychological patterns
    psych_patterns = llm_analysis.get("Psychological Patterns", 
                        llm_analysis.get("psychological_patterns", "No psychological analysis provided"))
    
    # Format risk management analysis
    risk_analysis = llm_analysis.get("Risk Management Analysis", 
                       llm_analysis.get("risk_management_analysis", "No risk analysis provided"))
    
    # Format strengths and improvements
    strengths = llm_analysis.get("Key Strengths Identified", 
                  llm_analysis.get("key_strengths_identified", "No strengths identified"))
    improvements = llm_analysis.get("Areas for Improvement", 
                     llm_analysis.get("areas_for_improvement", "No areas for improvement identified"))
    
    # Format recommendations
    recommendations = llm_analysis.get("Actionable Recommendations", 
